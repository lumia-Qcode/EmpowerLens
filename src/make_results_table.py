...
results_RUN2/all_experiments.csv, and a hand-maintained table drifts. Re-run after any
...
def main(argv=None):
    ...
    ap.add_argument("--csv", default="results_RUN2/all_experiments.csv")
    ...
    L = ["# Results — every experiment in one table\n",
         "Generated by `src/make_results_table.py` from `results_RUN2/all_experiments.csv`. "
